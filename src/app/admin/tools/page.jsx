...
const ICON_LIBRARY = [
  ...
  { value: "fa-solid fa-inbox", label: "Inbox" },
  { value: "fa-solid fa-paper-plane", label: "Send" },
  ...
  { value: "fa-solid fa-boxes-stacked", label: "Boxes" },
  ...
  { value: "fa-solid fa-check-double", label: "Double Check" },
  { value: "fa-solid fa-square-check", label: "Check Square" },
  { value: "fa-solid fa-file-pen", label: "File Edit" },
  { value: "fa-solid fa-file-circle-check", label: "File Check" },
  { value: "fa-solid fa-file-export", label: "File Export" },
  { value: "fa-solid fa-arrow-up-right-from-square", label: "External Link" },
  { value: "fa-solid fa-image", label: "Image" },
  { value: "fa-solid fa-camera", label: "Camera" },
  { value: "fa-solid fa-video", label: "Video" },
  { value: "fa-solid fa-play", label: "Play" },
  ...
  { value: "fa-solid fa-user-gear", label: "User Gear" },
  { value: "fa-solid fa-user-check", label: "User Check" },
  { value: "fa-solid fa-users", label: "Users" },
  { value: "fa-solid fa-people-group", label: "People Group" },
  { value: "fa-solid fa-person-chalkboard", label: "Training" },
  { value: "fa-solid fa-brain", label: "Brain" },
  { value: "fa-brands fa-slack", label: "Slack" },
  { value: "fa-brands fa-trello", label: "Trello" },
  { value: "fa-brands fa-jira", label: "Jira" },
  { value: "fa-brands fa-atlassian", label: "Atlassian" },
  { value: "fa-brands fa-figma", label: "Figma" },
  { value: "fa-brands fa-github", label: "GitHub" },
  { value: "fa-brands fa-google", label: "Google" },
  { value: "fa-brands fa-microsoft", label: "Microsoft" },
  { value: "fa-brands fa-dropbox", label: "Dropbox" },
